...
一、推文写作核心原则政治准确：严格遵循宣传口径，确保政策表述、术语使用符合官方规范
逻辑清晰：遵循「背景 — 内容 — 意义」的基本叙事结构
语言精炼：避免冗余表达，兼顾规范性、可读性与严肃性
格式统一：标题层级、标点与排版样式严格对标党政文稿要求

二、推文标题写作技巧标题类型 示例 适用场景政策解读型 「XX 政策」解读：XX 工作怎么干？ 政策宣贯类推文活动纪实型 XX 活动圆满举办：凝聚力量促发展 活动总结报道经验分享型 XX 单位：以 XX 举措推动 XX 工作落地 典型经验推广

三、正文写作规范开头：简要交代活动或政策背景，原则上控制在 100 字以内
主体：分点阐述核心内容，每段不超过 3 行，重点信息突出
结尾：总结意义或提出要求，形成首尾呼应，强化导向
四、排版与格式要求字体：正文宋体 / 仿宋，标题黑体（标题二号，正文小四）
行距：正文行距 1.5 倍，段落间距约 2 字符
标点：使用全角标点，数字和英文采用半角
配图：主题贴合、来源清晰，推荐宽度 800px

## 📷 配套指南：活动摄影技巧

一、摄影核心要求构图：突出主体，画面简洁，符合党政宣传审美
光线：优先自然光，室内活动避免面部阴影
角度：正式活动以正面或 45° 角为主
画质：分辨率不低于 1920×1080，画面清晰稳定
